            ...
            container.innerHTML = `
                <div class="datos-salud-externa">
                    ...
                    <div class="salud-perfil">
                        ...
                        <p><strong>⚖️ Peso:</strong> ${perfil.peso} kg | <strong>📏 Altura:</strong> ${perfil.altura} cm</p>
                    </div>
                    ...
                    <div class="salud-footer">
                        <small>⚠️ Datos de demostración. Conecta tu cuenta real para datos personales.</small>
...
// Función para conectar con Human API (redirige a OAuth)
